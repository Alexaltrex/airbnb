...
export const menuItemsArea = areas.map((el, index) => ({value: index, label: el}));
...
export const menuItemsBedrooms = bedrooms.map((el, index) => ({value: index, label: el}));

export const furnishings = [
    "Standard",
    "Premium"
];
export const menuItemsFurnishing = furnishings.map((el, index) => ({value: index, label: el}));
